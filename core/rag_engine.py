...
class RAGEngine:
    ...
    def _build_prompt(self, query: str, context: str, history: List[ChatMessage]) -> List[ChatMessage]:
...
Please answer the question based on the context above. If the context doesn't fully answer the question, you can use your general knowledge but please indicate what information comes from the context vs general knowledge."""
    ...
    def query(self, 
              ...
              use_web: bool = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if use_documents is None or use_web is None:
                use_documents = self.retrieval_mode in [RetrievalMode.DOCUMENTS_ONLY, RetrievalMode.HYBRID]
                use_web = self.retrieval_mode in [RetrievalMode.WEB_ONLY, RetrievalMode.HYBRID]
    ...
    def _update_conversation_history(self, session_id: str = None, question: str = None, answer: str = None):
